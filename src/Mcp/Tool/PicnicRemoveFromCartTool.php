...
class PicnicRemoveFromCartTool implements ToolInterface
{
    ...
    {
        return 'Remove one or more units of a product from the Picnic shopping cart by product ID.';
    }
    ...
    public function getInputSchema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'count' => [
                    'type' => 'integer',
                    'description' => 'How many units to remove. Defaults to 1.',
                    'minimum' => 1,
                ],
                'account' => [
                    'type' => 'string',
        ...
        try {
            ...
            return [
                'content' => [['type' => 'text', 'text' => json_encode([
                    'removed' => ['product_id' => $productId, 'count' => $count],
                    'cart' => $cart,
